...
//        Log.d("demo", "getView: "+t.title);
        viewHolder.tvTitle.setText(event.eTitle);
        viewHolder.tvDescription.setText(event.eDescription);
        viewHolder.tvDate.setText(formatDate(event.eDate));
        viewHolder.tvTime.setText("From "+event.eStartTime+" To "+event.eEndTime);
